    ...
    class CandyCloudController : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            switch (random)
            {
                ...
                case -3: m_speedFactX = 1.5f; break;
                case -2: m_speedFactX = 2.5f; break;
                case -1: m_speedFactX = 3.0f; break;
                case 0: m_speedFactX = 3.5f; break;
                case 1: m_speedFactX = 4.0f; break;
                case 2: m_speedFactX = 4.5f; break;
                case 3: m_speedFactX = 5.0f; break;
                case 4: m_speedFactX = 5.5f; break;
                case 5: m_speedFactX = 6.0f; break;
            }
        ...
        void Update()
        {
            ...
            if ((m_speedFactX > 1.0f) && (m_speedFactX <= 1.5f))
            {
                m_speedX = 0.7f + 0.7f * Mathf.Sin(Time.time) * m_speedFactX;
            }
            if ((m_speedFactX > 1.5f) && (m_speedFactX <= 2.5f))
            {
                m_speedX = 0.8f + 0.8f * Mathf.Cos(Time.time) * m_speedFactX;
            }
            if ((m_speedFactX > 2.5f) && (m_speedFactX <= 3.0f))
            {
            ...
            if ((m_speedFactX > 4.0f) && (m_speedFactX <= 4.5f))//***
            {
                m_speedX = 0.9f + Mathf.Sin(Time.time) * m_speedFactX;
            }
            if ((m_speedFactX > 4.5f) && (m_speedFactX <= 5.0f))
            {
                m_speedX = 0.9f + 2.0f * Mathf.Cos(Time.time) * m_speedFactX;
            }
            if ((m_speedFactX > 5.0f) && (m_speedFactX <= 5.5f))
            {
                m_speedX = 2.0f + Mathf.Sin(Time.time) * m_speedFactX;
            }
            if ((m_speedFactX > 5.5f) && (m_speedFactX <= 6.0f))
            {
